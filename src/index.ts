...
export { default as CitizenSummarySidesheet } from './components/CitizenSummarySidesheet.vue';

export { default as CitizenComponentsPlugin } from './plugin';
export { default } from './plugin';

export type { CitizenComponentsConfig } from './config';

export type { Citizen } from './services/citizen/citizen.types';
export type { CitizenSelectModelType, Nullable } from './types';
